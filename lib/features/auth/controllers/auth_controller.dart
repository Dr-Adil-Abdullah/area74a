...
class AuthController extends Notifier<AuthState> {
  ...
  /// Back from the standalone wizard. Cloud connect is disabled in this
  /// fork — stay on local setup.
  ...
  Future<void> hydrate() async {
    ...
    if (wsInfo == null) {
      ...
      // Pharmacy POS is standalone-only: first boot is local owner + PIN.
      state = const StandaloneSetupRequired();
      return;
    }
