...
void main() {
  ...
  runZonedGuarded<Future<void>>(() async {
    ...
    if (_isDesktop) {
      ...
      await windowManager.setTitle('Pharmacy POS');
...
class _PosAppState extends State<PosApp> {
  ...
  static const _flags = FeatureFlags.allDrift;
  ...
  Future<void> _loadTenantId() async {
    try {
      // Standalone (pharmacy) path: tenant/store minted locally. Must win
          ...
          home: Consumer(
            builder: (context, ref, _) {
              ...
              if (state is RegisterNotActivated) {
                // Standalone-only product: never show the cloud activation
                // code screen. First boot is local owner + PIN.
